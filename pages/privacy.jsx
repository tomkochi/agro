...
export default function privacy() {
 ...
 <>
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        Company downloaded by You on any electronic device, named Agrofocal
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>
        ...
        "Us" or "Our" in this Agreement) refers to Agrofocal Technologies, Inc,
        San Jose, CA 95148.
      </p>
    </li>
    <li>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to Agrofocal , accessible from{" "}
        <a href="Agrofocal.ai" rel="external nofollow noopener" target="_blank">
          Agrofocal.ai
        </a>
      </p>
    </li>
  ...
  <ul>
    ...
    <li>
      <strong>From Service Providers</strong>. For example, or other third-party
  ...
  <ul>
    ...
    <li>
      <strong>The right to request.</strong> Under CCPA, You have the right to
    ...
    <li>
      <strong>The right to delete Personal Data.</strong> You have the right to
  ...
  <ul>
    <li>
      ...
      <a
        href="https://agrofocal.ai/contact"
        rel="external nofollow noopener"
        target="_blank"
      >
        https://agrofocal.ai/contact
      </a>
    </li>
  </ul>
  <p>
